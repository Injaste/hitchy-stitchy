...
- [reserved-slugs.md](reserved-slugs.md) — why root-level `/:slug` URLs force us to pre-reserve system/route/brand/plan-tier paths, and the rule: reserve a route's path when you add the route.
