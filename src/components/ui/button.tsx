...
// Focus ring opacity (ring-ring/70) is hardcoded here to match fieldRing in
// field-styles.ts. If you change the opacity there, update it here too.
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/70 active:not-aria-[haspopup]:scale-[0.95] disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 cursor-pointer capitalize ",
  {
    variants: {
      variant: {
        default:
        ...
        sun:
          "bg-sun/10 text-sun hover:bg-sun/20 focus-visible:border-sun/40 focus-visible:ring-sun/20",
        destructive:
      ...
      size: {
        ...
        md: "h-9 gap-1.5 px-2.5 in-data-[slot=button-group]:rounded-xl has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
