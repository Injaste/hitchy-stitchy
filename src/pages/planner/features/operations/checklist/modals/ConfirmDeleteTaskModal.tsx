...
export function ConfirmDeleteTaskModal() {
  ...
  const { isConfirmDeleteTaskModalOpen, taskToDelete, closeConfirmDeleteTask } =
    useModalStore();
  ...
  const confirmDeleteTask = () => {
    ...
    if (task) {
      ...
      if (
        isAdmin ||
        task.assignees.includes(currentRole) ||
  ...
  return (
    <AlertDialog
      open={isConfirmDeleteTaskModalOpen}
      onOpenChange={closeConfirmDeleteTask}
    >
      <AlertDialogContent>
        <AlertDialogHeader>
