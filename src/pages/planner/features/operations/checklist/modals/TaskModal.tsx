...
import { AssigneeCheckboxes } from "@/pages/planner/components/AssigneeCheckboxes";
...
export function TaskModal() {
  ...
  const [day, setDay] = useState<string>(editingTask?.day ?? "Pre-wedding");
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Select
                value={priority}
                onValueChange={(v) =>
                  setPriority(v as ChecklistItem["priority"])
                }
              >
