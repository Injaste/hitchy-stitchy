...
export function ConfirmUpdateActiveEventModal() {
  ...
  const confirmUpdateActiveEvent = () => {
    ...
    if (activeCueEvent?.id === pendingEventUpdate.id)
      setActiveCueEvent(pendingEventUpdate);
  ...
  return (
    <AlertDialog
      open={isConfirmUpdateActiveEventModalOpen}
      onOpenChange={closeConfirmUpdateActiveEvent}
    >
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Update Active Event?</AlertDialogTitle>
          <AlertDialogDescription>
            This event is currently live. Updating it will change the active cue
            display.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel>Cancel</AlertDialogCancel>
          <AlertDialogAction onClick={confirmUpdateActiveEvent}>
            Update Event
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
