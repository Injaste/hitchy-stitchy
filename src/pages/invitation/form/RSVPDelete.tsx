  ...
  return (
    <AlertDialog open={open} onOpenChange={(o) => !o && onCancel()}>
      <AlertDialogContent className="rounded-2xl border border-primary/20 bg-card/95 backdrop-blur-md max-w-sm font-medium">
        <AlertDialogHeader>
          <AlertDialogTitle className="font-serif italic text-primary text-xl">
            Remove your RSVP?
          </AlertDialogTitle>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel
            asChild
            onClick={onCancel}
            className="rounded-xl border-primary/30 font-bold font-serif"
          >
            <motion.button
          ...
          <AlertDialogAction
            asChild
            onClick={onConfirm}
            className="rounded-xl  bg-destructive hover:bg-destructive/90 font-bold font-serif"
          >
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
