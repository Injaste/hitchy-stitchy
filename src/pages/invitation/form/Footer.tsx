...
const Footer: FC<FooterProps> = ({ fadeIn, fadeUp }) => {
  return (
    <motion.div
      initial="hidden"
      whileInView="show"
    ...
    >
      ...
      <motion.h2
        ...
        className="font-bold text-white [text-shadow:2px_2px_0_#d4af37,-2px_-2px_0_#d4af37,2px_-2px_0_#d4af37,-2px_2px_0_#d4af37] text-2xl sm:text-3xl italic font-serif"
      >
        Danish & Nadhirah
      </motion.h2>
