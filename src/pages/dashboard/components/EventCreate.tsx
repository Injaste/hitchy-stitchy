...
const CreateEvent = () => {
  return (
    <motion.div variants={itemFadeUp} className="hidden sm:block">
      <Link to="/create-event">
        <motion.div
          whileHover={cardHover}
          className="h-[223.5px] min-h-48 rounded-xl border-2 border-dashed border-border hover:border-primary/30 bg-transparent hover:bg-primary/3 transition-colors flex flex-col items-center justify-center gap-3 p-6 cursor-pointer group"
        >
