...
export const creamClassicSchema = [
  {
    title: "Typography",
  ...
  },
  {
    title: "Couple",
    fields: [
      { key: "groom_name", label: "Groom Name", type: "text", placeholder: "e.g. Daniel" },
      { key: "bride_name", label: "Bride Name", type: "text", placeholder: "e.g. Grace" },
    ],
  },
  {
    title: "Countdown",
  ...
  },
  {
    title: "Hero",
    fields: [
      { key: "greeting", label: "Greeting", type: "textarea", placeholder: "e.g. You are invited to celebrate the wedding of" },
      { key: "hero_divider_label", label: "Divider Label", type: "text", default: "The wedding of", placeholder: "e.g. The wedding of" },
      { key: "quote", label: "Quote / Blessing", type: "textarea", placeholder: "e.g. Two souls, one heart" },
      { key: "quote_source", label: "Quote Source", type: "text", placeholder: "e.g. —" },
    ],
  },
  {
    title: "Invitation",
    fields: [
      { key: "section_title", label: "Section Title", type: "text", placeholder: "e.g. A celebration of love" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "blessings_name", label: "Name", type: "textarea", placeholder: "e.g. Mr & Mrs Tan" },
      { key: "blessings_label", label: "Label", type: "text", placeholder: "e.g. Parents of the couple" },
    ],
  },
  {
    title: "Venue",
    fields: [
      { key: "date", label: "Date", type: "text", placeholder: "eg. 16th July 2026", default: "16th July 2026" },
      { key: "time", label: "Time", type: "text", placeholder: "eg. 3 pm", default: "3.00 PM" },
      { key: "venue_name", label: "Venue Name", type: "text", placeholder: "e.g. The Garden Pavilion" },
      { key: "venue_address", label: "Venue Address", type: "textarea", placeholder: "Full address…" },
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Garden formal" },
  ...
  },
  {
    ...
    fields: [
      { key: "itinerary_title", label: "Section Title", type: "text", default: "Programme", placeholder: "e.g. Programme" },
      {
        ...
        placeholder: "",
        itemFields: [
          { key: "time", label: "Time", placeholder: "e.g. 3.00 PM" },
          { key: "label", label: "Label", placeholder: "e.g. Exchange of vows" },
        ],
      },
  ...
  },
  {
    title: "Footer",
    fields: [
      { key: "footer_tagline", label: "Tagline", type: "text", default: "With love and gratitude", placeholder: "e.g. With love and gratitude" },
    ],
  },
  {
    title: "Meta",
    ...
    fields: [
      { key: "page_title", label: "Page Title", type: "text", placeholder: "e.g. The Wedding of Daniel & Grace", hint: "Shown in the browser tab and link previews. Leave blank to use the default." },
...
export type CreamClassicPageConfig = {
  slug: "cream-classic"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof creamClassicSchema>, "itinerary">]?: string | null
}
