...
export const mughalIndianSchema = [
  {
    title: "Typography",
  ...
  },
  {
    title: "Couple",
    fields: [
      { key: "groom_name", label: "Groom Name", type: "text", placeholder: "e.g. Vikram" },
      { key: "bride_name", label: "Bride Name", type: "text", placeholder: "e.g. Ishani" },
    ],
  },
  {
    title: "Countdown",
  ...
  },
  {
    title: "Hero",
    fields: [
      { key: "greeting", label: "Greeting", type: "textarea", placeholder: "e.g. By the grace of the divine" },
      { key: "hero_divider_label", label: "Divider Label", type: "text", default: "The Royal Wedding of", placeholder: "e.g. The Royal Wedding of" },
      { key: "quote", label: "Blessing / Shloka", type: "textarea", placeholder: "e.g. A union written in the stars" },
  ...
  },
  {
    title: "Invitation",
    fields: [
      { key: "section_title", label: "Section Title", type: "text", placeholder: "e.g. A Royal Celebration" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "blessings_name", label: "Name", type: "textarea", placeholder: "e.g. Mr & Mrs Singh" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "venue_name", label: "Venue Name", type: "text", placeholder: "e.g. The Palace Gardens" },
      { key: "venue_address", label: "Venue Address", type: "textarea", placeholder: "Full address…" },
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Royal — Maroon & Gold" },
    ...
    fields: [
      { key: "itinerary_title", label: "Section Title", type: "text", default: "Programme", placeholder: "e.g. Programme" },
      {
        ...
        itemFields: [
          ...
          { key: "label", label: "Label", placeholder: "e.g. Baraat" },
        ],
      },
      { key: "footnote", label: "Footnote", type: "text", default: "", placeholder: "e.g. A royal feast to follow" },
    ],
  },
  {
    title: "RSVP",
    fields: [
      { key: "rsvp_subtitle", label: "Subtitle", type: "text", default: "Your presence would honour us.", placeholder: "e.g. Your presence would honour us." },
  ...
  },
  {
    title: "Footer",
    fields: [
      { key: "footer_tagline", label: "Tagline", type: "text", default: "With love and grandeur", placeholder: "e.g. With love and grandeur" },
    ],
  },
  {
    title: "Meta",
    ...
    fields: [
      { key: "page_title", label: "Page Title", type: "text", placeholder: "e.g. The Wedding of Vikram & Ishani", hint: "Shown in the browser tab and link previews. Leave blank to use the default." },
...
export type MughalIndianPageConfig = {
  slug: "mughal-indian"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof mughalIndianSchema>, "itinerary">]?: string | null
}
