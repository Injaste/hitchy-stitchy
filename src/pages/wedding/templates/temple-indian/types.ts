...
export const templeIndianSchema = [
  {
    title: "Typography",
  ...
  },
  {
    title: "Couple",
    fields: [
      { key: "groom_name", label: "Groom Name", type: "text", placeholder: "e.g. Karthik" },
      { key: "bride_name", label: "Bride Name", type: "text", placeholder: "e.g. Lakshmi" },
    ],
  },
  {
    title: "Countdown",
  ...
  },
  {
    title: "Hero",
    fields: [
      { key: "greeting", label: "Greeting", type: "textarea", placeholder: "e.g. With the blessings of the Almighty" },
      { key: "hero_divider_label", label: "Divider Label", type: "text", default: "The Wedding of", placeholder: "e.g. The Wedding of" },
      { key: "quote", label: "Blessing / Shloka", type: "textarea", placeholder: "e.g. ॐ — may the divine bless this union" },
  ...
  },
  {
    title: "Invitation",
    fields: [
      { key: "section_title", label: "Section Title", type: "text", placeholder: "e.g. Shubha Vivaham" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "blessings_name", label: "Name", type: "textarea", placeholder: "e.g. Mr & Mrs Iyer" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "venue_name", label: "Venue Name", type: "text", placeholder: "e.g. Sri Kalyana Mandapam" },
      { key: "venue_address", label: "Venue Address", type: "textarea", placeholder: "Full address…" },
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Traditional — Silk & Gold" },
  ...
  },
  {
    title: "Itinerary",
    fields: [
      { key: "itinerary_title", label: "Section Title", type: "text", default: "Muhurtham", placeholder: "e.g. Muhurtham" },
      {
        key: "itinerary",
        label: "Ceremonies",
        type: "section-list",
        placeholder: "",
        itemFields: [
          { key: "time", label: "Time", placeholder: "e.g. 6:00 AM" },
          { key: "label", label: "Label", placeholder: "e.g. Kashi Yatra" },
        ],
      },
      { key: "footnote", label: "Footnote", type: "text", default: "", placeholder: "e.g. Lunch to follow" },
    ],
  },
  {
    title: "RSVP",
    fields: [
      { key: "rsvp_subtitle", label: "Subtitle", type: "text", default: "Your presence would bless us.", placeholder: "e.g. Your presence would bless us." },
      { key: "rsvp_success_heading", label: "Success Heading", type: "text", default: "Nandri!", placeholder: "e.g. Nandri!" },
  ...
  },
  {
    ...
    fields: [
      { key: "page_title", label: "Page Title", type: "text", placeholder: "e.g. The Wedding of Karthik & Lakshmi", hint: "Shown in the browser tab and link previews. Leave blank to use the default." },
...
export type TempleIndianPageConfig = {
  slug: "temple-indian"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof templeIndianSchema>, "itinerary">]?: string | null
}
