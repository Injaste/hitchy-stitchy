...
export const peonyChineseSchema = [
  {
    title: "Typography",
  ...
  },
  {
    title: "Couple",
    fields: [
      { key: "groom_name", label: "Groom Name", type: "text", placeholder: "e.g. Wei" },
      { key: "bride_name", label: "Bride Name", type: "text", placeholder: "e.g. Mei" },
    ],
  },
  {
    title: "Countdown",
  ...
  },
  {
    title: "Hero",
    fields: [
      { key: "greeting", label: "Greeting", type: "textarea", placeholder: "e.g. 诚邀您见证我们的喜悦" },
      { key: "hero_divider_label", label: "Divider Label", type: "text", default: "The Wedding of", placeholder: "e.g. The Wedding of" },
      { key: "quote", label: "Quote / Blessing", type: "textarea", placeholder: "e.g. 花好月圆" },
      { key: "quote_source", label: "Quote Source", type: "text", placeholder: "e.g. Blooming flowers, full moon" },
    ],
  },
  {
    title: "Invitation",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "blessings_name", label: "Name", type: "textarea", placeholder: "e.g. Mr & Mrs Chen" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Garden Formal — Blush & Rose" },
    ...
    fields: [
      { key: "itinerary_title", label: "Section Title", type: "text", default: "Programme", placeholder: "e.g. Programme" },
      {
        ...
        itemFields: [
          ...
          { key: "label", label: "Label", placeholder: "e.g. Tea Ceremony" },
        ],
      },
  ...
  },
  {
    ...
    fields: [
      { key: "page_title", label: "Page Title", type: "text", placeholder: "e.g. The Wedding of Wei & Mei", hint: "Shown in the browser tab and link previews. Leave blank to use the default." },
...
export type PeonyChinesePageConfig = {
  slug: "peony-chinese"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof peonyChineseSchema>, "itinerary">]?: string | null
}
