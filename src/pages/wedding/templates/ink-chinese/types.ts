...
export const inkChineseSchema = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "quote", label: "Quote / Blessing", type: "textarea", placeholder: "e.g. 执子之手，与子偕老" },
      { key: "quote_source", label: "Quote Source", type: "text", placeholder: "e.g. Hand in hand, we grow old together" },
    ],
  },
  {
    title: "Invitation",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Smart — Ink & Cream" },
...
export type InkChinesePageConfig = {
  slug: "ink-chinese"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof inkChineseSchema>, "itinerary">]?: string | null
}
