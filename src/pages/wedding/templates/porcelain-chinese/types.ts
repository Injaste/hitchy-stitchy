...
export const porcelainChineseSchema = [
  {
    title: "Typography",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "quote", label: "Quote / Blessing", type: "textarea", placeholder: "e.g. 永结同心" },
      { key: "quote_source", label: "Quote Source", type: "text", placeholder: "e.g. Forever of one heart" },
    ],
  },
  {
    title: "Invitation",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Elegant — Blue & White" },
...
export type PorcelainChinesePageConfig = {
  slug: "porcelain-chinese"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof porcelainChineseSchema>, "itinerary">]?: string | null
}
