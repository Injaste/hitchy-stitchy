...
export const crescentMuslimSchema = [
  {
    title: "Typography",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "hero_divider_label", label: "Divider Label", type: "text", default: "are getting married", placeholder: "e.g. are getting married" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Traditional — Shades of Sage" },
...
export type CrescentMuslimPageConfig = {
  slug: "crescent-muslim"
  // itinerary is structured (section-list), not a string.
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof crescentMuslimSchema>, "itinerary">]?:
    | string
    | null
}
