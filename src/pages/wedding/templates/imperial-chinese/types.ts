...
export const imperialChineseSchema = [
  {
    title: "Typography",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "quote", label: "Quote / Blessing", type: "textarea", placeholder: "e.g. 龙凤呈祥" },
      { key: "quote_source", label: "Quote Source", type: "text", placeholder: "e.g. Prosperity brought by dragon and phoenix" },
    ],
  },
  {
    title: "Invitation",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Black Tie — Oxblood & Gold" },
...
export type ImperialChinesePageConfig = {
  slug: "imperial-chinese"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof imperialChineseSchema>, "itinerary">]?: string | null
}
