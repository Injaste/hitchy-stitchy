...
export const royalMuslimSchema = [
  {
    title: "Typography",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Formal — Burgundy & Gold" },
...
export type RoyalMuslimPageConfig = {
  slug: "royal-muslim"
  // itinerary is structured (section-list), not a string.
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof royalMuslimSchema>, "itinerary">]?:
    | string
    | null
}
