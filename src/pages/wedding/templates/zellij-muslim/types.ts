...
export const zellijMuslimSchema = [
  {
    title: "Typography",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Festive — Terracotta & Teal" },
...
export type ZellijMuslimPageConfig = {
  slug: "zellij-muslim"
  // itinerary is structured (section-list), not a string.
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof zellijMuslimSchema>, "itinerary">]?:
    | string
    | null
}
