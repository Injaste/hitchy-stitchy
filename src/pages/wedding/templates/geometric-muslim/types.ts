...
export const geometricMuslimSchema = [
  {
    title: "Typography",
...
export type GeometricMuslimPageConfig = {
  slug: "geometric-muslim"
  // itinerary is structured (section-list), not a string.
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof geometricMuslimSchema>, "itinerary">]?:
    | string
    | null
}
