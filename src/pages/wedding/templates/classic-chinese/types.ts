...
export const classicChineseSchema = [
  {
    title: "Typography",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "quote", label: "Quote / Blessing", type: "textarea", placeholder: "e.g. 百年好合" },
      { key: "quote_source", label: "Quote Source", type: "text", placeholder: "e.g. A Hundred Years of Harmony" },
    ],
  },
  {
    title: "Invitation",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Festive — Red & Gold" },
...
export type ClassicChinesePageConfig = {
  slug: "classic-chinese"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof classicChineseSchema>, "itinerary">]?: string | null
}
