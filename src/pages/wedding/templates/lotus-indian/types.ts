...
export const lotusIndianSchema = [
  {
    title: "Typography",
  ...
  },
  {
    title: "Couple",
    fields: [
      { key: "groom_name", label: "Groom Name", type: "text", placeholder: "e.g. Aditya" },
      { key: "bride_name", label: "Bride Name", type: "text", placeholder: "e.g. Sara" },
    ],
  },
  {
    title: "Countdown",
  ...
  },
  {
    title: "Hero",
    fields: [
      { key: "greeting", label: "Greeting", type: "textarea", placeholder: "e.g. We're getting married" },
      { key: "hero_divider_label", label: "Divider Label", type: "text", default: "Save the Date", placeholder: "e.g. Save the Date" },
      { key: "quote", label: "Blessing / Note", type: "textarea", placeholder: "e.g. To love and be loved" },
      { key: "quote_source", label: "Note Source", type: "text", placeholder: "e.g. — together at last" },
    ],
  },
  {
    title: "Invitation",
    fields: [
      { key: "section_title", label: "Section Title", type: "text", placeholder: "e.g. Our Story" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "blessings_name", label: "Name", type: "textarea", placeholder: "e.g. The Mehta & Khan Families" },
      { key: "blessings_label", label: "Label", type: "text", placeholder: "e.g. joyfully invite you" },
    ],
  },
  {
    title: "Venue",
    fields: [
      ...
      { key: "venue_name", label: "Venue Name", type: "text", placeholder: "e.g. The Riverside Lawns" },
      { key: "venue_address", label: "Venue Address", type: "textarea", placeholder: "Full address…" },
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Indian Contemporary — Pastels" },
  ...
  },
  {
    title: "Itinerary",
    fields: [
      { key: "itinerary_title", label: "Section Title", type: "text", default: "The Day", placeholder: "e.g. The Day" },
      {
        key: "itinerary",
        label: "Schedule",
        type: "section-list",
        placeholder: "",
        itemFields: [
          { key: "time", label: "Time", placeholder: "e.g. 5:00 PM" },
          { key: "label", label: "Label", placeholder: "e.g. Pheras" },
        ],
      },
      { key: "footnote", label: "Footnote", type: "text", default: "", placeholder: "e.g. Dinner & dancing to follow" },
    ],
  },
  {
    title: "RSVP",
    fields: [
      { key: "rsvp_subtitle", label: "Subtitle", type: "text", default: "We'd love for you to join us.", placeholder: "e.g. We'd love for you to join us." },
      { key: "rsvp_success_heading", label: "Success Heading", type: "text", default: "Thank you!", placeholder: "e.g. Thank you!" },
  ...
  },
  {
    title: "Footer",
    fields: [
      { key: "footer_tagline", label: "Tagline", type: "text", default: "We can't wait to celebrate with you", placeholder: "e.g. We can't wait to celebrate with you" },
    ],
  },
  {
    title: "Meta",
    ...
    fields: [
      { key: "page_title", label: "Page Title", type: "text", placeholder: "e.g. The Wedding of Aditya & Sara", hint: "Shown in the browser tab and link previews. Leave blank to use the default." },
...
export type LotusIndianPageConfig = {
  slug: "lotus-indian"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof lotusIndianSchema>, "itinerary">]?: string | null
}
