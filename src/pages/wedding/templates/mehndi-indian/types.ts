...
export const mehndiIndianSchema = [
  {
    title: "Typography",
  ...
  },
  {
    title: "Couple",
    fields: [
      { key: "groom_name", label: "Groom Name", type: "text", placeholder: "e.g. Rohan" },
      { key: "bride_name", label: "Bride Name", type: "text", placeholder: "e.g. Aanya" },
    ],
  },
  {
    title: "Countdown",
  ...
  },
  {
    title: "Hero",
    fields: [
      { key: "greeting", label: "Greeting", type: "textarea", placeholder: "e.g. Together with our families" },
      { key: "hero_divider_label", label: "Divider Label", type: "text", default: "The Wedding of", placeholder: "e.g. The Wedding of" },
      { key: "quote", label: "Blessing / Shloka", type: "textarea", placeholder: "e.g. Two souls, one journey" },
  ...
  },
  {
    title: "Invitation",
    fields: [
      { key: "section_title", label: "Section Title", type: "text", placeholder: "e.g. An Invitation" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "blessings_name", label: "Name", type: "textarea", placeholder: "e.g. Mr & Mrs Kapoor" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "venue_name", label: "Venue Name", type: "text", placeholder: "e.g. The Heritage Haveli" },
      { key: "venue_address", label: "Venue Address", type: "textarea", placeholder: "Full address…" },
      { key: "dress_code", label: "Dress Code / Attire", type: "text", placeholder: "e.g. Traditional — Green & Gold" },
  ...
  },
  {
    title: "Itinerary",
    fields: [
      { key: "itinerary_title", label: "Section Title", type: "text", default: "Ceremonies", placeholder: "e.g. Ceremonies" },
      {
        key: "itinerary",
        label: "Ceremonies",
        type: "section-list",
        ...
        itemFields: [
          ...
          { key: "label", label: "Label", placeholder: "e.g. Mehndi Ceremony" },
        ],
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "rsvp_success_heading", label: "Success Heading", type: "text", default: "Shukriya!", placeholder: "e.g. Shukriya!" },
  ...
  },
  {
    ...
    fields: [
      { key: "page_title", label: "Page Title", type: "text", placeholder: "e.g. The Wedding of Rohan & Aanya", hint: "Shown in the browser tab and link previews. Leave blank to use the default." },
...
export type MehndiIndianPageConfig = {
  slug: "mehndi-indian"
  itinerary?: SectionListValue
} & {
  [K in Exclude<ExtractKeys<typeof mehndiIndianSchema>, "itinerary">]?: string | null
}
