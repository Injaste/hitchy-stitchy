...
export function EventLogPanel() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      msg: "Task Done",
      className:
        "bg-secondary/20 text-secondary-foreground border border-border hover:bg-secondary/30",
          ...
          <div className="p-3 space-y-2">
            {logs.length === 0 ? (
              ...
              logs.map((log) => (
                <div
                  key={log.id}
                  className="text-sm p-2.5 bg-card rounded-md border border-border shadow-sm"
                >
