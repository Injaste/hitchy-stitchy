    ...
    <motion.div initial="hidden" animate="show" variants={fadeUp(0.2)}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pre-approve guests for pool-mode RSVPs. One name per line. Optionally add
            phone: <code className="text-xs bg-muted px-1 rounded">Name, +601x</code>
          </CardDescription>
        </CardHeader>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">
                    {guests.length} guest{guests.length !== 1 ? "s" : ""} in pool
                  </p>
                  <Button
                    onClick={() => save(guests)}
                    disabled={isPending}
                  ...
                  <div className="space-y-1">
                    {guests.map((g) => (
                      ...
                      >
                        ...
                        <Badge
                          variant={g.status === "claimed" ? "default" : "secondary"}
