          ...
          <Field>
            ...
            <FieldContent>
              <Input
                ...
                value={cur.groom_name ?? ""}
                onChange={(e) => upd({ groom_name: e.target.value || null })}
              />
            </FieldContent>
          </Field>
          <Field>
            ...
            <FieldContent>
              <Input
                ...
                value={cur.bride_name ?? ""}
                onChange={(e) => upd({ bride_name: e.target.value || null })}
              />
            </FieldContent>
          </Field>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Field>
            ...
            <FieldContent>
              <Input
                ...
                value={cur.event_time_start ?? ""}
                onChange={(e) =>
                  upd({ event_time_start: e.target.value || null })
                }
              />
            </FieldContent>
          </Field>
          <Field>
            ...
            <FieldContent>
              <Input
                placeholder="5:00 PM"
                value={cur.event_time_end ?? ""}
                onChange={(e) =>
                  upd({ event_time_end: e.target.value || null })
                }
              />
            </FieldContent>
          </Field>
          ...
          <Field>
            ...
            <FieldContent>
              <Input
                ...
                value={cur.venue_name ?? ""}
                onChange={(e) => upd({ venue_name: e.target.value || null })}
              />
            </FieldContent>
          </Field>
        </AnimateItem>
          ...
          <Field>
            ...
            <FieldContent>
              <Textarea
                ...
                value={cur.venue_address ?? ""}
                onChange={(e) => upd({ venue_address: e.target.value || null })}
              />
            </FieldContent>
          </Field>
        </AnimateItem>
          ...
          <Field>
            ...
            <FieldContent>
              <Input
                ...
                value={cur.venue_map_link ?? ""}
                onChange={(e) =>
                  upd({ venue_map_link: e.target.value || null })
                }
              />
            </FieldContent>
          </Field>
          ...
          <Field>
            ...
            <FieldContent>
              <Input
                ...
                value={cur.venue_map_embed_url ?? ""}
                onChange={(e) =>
                  upd({ venue_map_embed_url: e.target.value || null })
                }
              />
            </FieldContent>
          </Field>
          ...
          <Field>
            ...
            <FieldContent>
              <Input
                type="number"
                min={1}
                value={cur.guest_count_min}
                onChange={(e) =>
                  upd({ guest_count_min: Number(e.target.value) || 1 })
                }
              />
            </FieldContent>
          </Field>
          <Field>
            ...
            <FieldContent>
              <Input
                type="number"
                min={1}
                value={cur.guest_count_max}
                onChange={(e) =>
                  upd({ guest_count_max: Number(e.target.value) || 10 })
                }
              />
            </FieldContent>
          </Field>
          ...
          <Field>
            ...
            <FieldContent>
              <Input
                ...
                value={cur.confirmation_message}
